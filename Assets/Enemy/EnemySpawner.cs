...
public class EnemySpawner : MonoBehaviour
{
    ...
    private IEnumerator spawn()
    {
        ...
        while (enemyCount < numEnemiesToSpawn)
        {
            ...
            for (int i = 0; i < numEnemies; i++)
            {
                ...
                // Instantiate and position an enemy within the spawnRange
    ...
    // Coroutine to remove doors after all enemies have been spawned and defeated
